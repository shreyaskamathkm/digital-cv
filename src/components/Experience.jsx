...
const education = [
  {
    ...
    year: 'Feb 2022',
    thesis:
      'Dissertation: Advancing Multimodal Data through Artificial Intelligence Technologies with Applications to Biometrics and Nutrition Science',
  ...
  },
  {
    ...
    year: 'May 2016',
    thesis:
      'Thesis: Fingerprint Image Quality Assessment, Verification, and Detection',
...
const experience = [
  {
    ...
    narrative:
      'At SimpliSafe, I build the AI brain behind home security cameras — designing cloud-based detection models, curating large-scale datasets, and architecting the distributed training pipelines that power computer vision at scale. SimpliSafe protects over 4 million people across the US and UK, and my models are part of the system keeping those homes safe.',
    details: [
  ...
  },
  {
    ...
    narrative:
      'My first industry experience applying deep learning to a real-world security problem — building AI models to detect contraband in X-ray scans and using GANs to generate synthetic training data when real examples were scarce.',
    details: [
  ...
  },
  {
    ...
    narrative:
      'My PhD at Tufts spanned computer vision, AI for healthcare, and biometrics — funded by $429K+ in competitive grants. I built TDFace (now used by 10,000+ researchers worldwide), developed AI systems for automated nutrition assessment, and published research across thermal imaging, face analysis, image restoration, and medical AI.',
    details: [
  ...
  },
  {
    ...
    narrative:
      "My master's research at UTSA focused on biometric systems — building algorithms that could enhance, classify, and authenticate fingerprints more accurately than existing methods.",
    details: [
